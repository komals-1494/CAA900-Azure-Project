...
RG_NAME="Student-RG-1230102"     # your student group
LOCATION="canadacentral"    # your location
ID="96"          #unique ID assigned to you

Student_vnet_name="Student-1230102-vnet"
Student_vnet_address="10.28.202.0/24"
Client_Subnet_name="Virtual-Desktop-Client"
Client_Subnet_address="10.28.202.0/24"
